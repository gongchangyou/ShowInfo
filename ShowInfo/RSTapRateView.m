...
- (id)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    [_oneStarButton setImage:[UIImage imageNamed:@"Resource/star_empty.png"] forState:UIControlStateNormal];
    [_oneStarButton setImage:[UIImage imageNamed:@"Resource/star_full.png"] forState:UIControlStateSelected];
    ...
    [_twoStarButton setImage:[UIImage imageNamed:@"Resource/star_empty.png"] forState:UIControlStateNormal];
    [_twoStarButton setImage:[UIImage imageNamed:@"Resource/star_full.png"] forState:UIControlStateSelected];
    ...
    [_threeStarButton setImage:[UIImage imageNamed:@"Resource/star_empty.png"] forState:UIControlStateNormal];
    [_threeStarButton setImage:[UIImage imageNamed:@"Resource/star_full.png"] forState:UIControlStateSelected];
    ...
    [_fourStarButton setImage:[UIImage imageNamed:@"Resource/star_empty.png"] forState:UIControlStateNormal];
    [_fourStarButton setImage:[UIImage imageNamed:@"Resource/star_full.png"] forState:UIControlStateSelected];
    ...
    [_fiveStarButton setImage:[UIImage imageNamed:@"Resource/star_empty.png"] forState:UIControlStateNormal];
    [_fiveStarButton setImage:[UIImage imageNamed:@"Resource/star_full.png"] forState:UIControlStateSelected];
    ...
    UIColor *color = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.0];
...
- (void)reflectionViewRefresh {
  ...
  if (!self.oneStarButton.selected) {
    imageView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Resource/star_empty.png"]] autorelease];
  } else {
    imageView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Resource/star_full.png"]] autorelease];
  }
